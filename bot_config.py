...
if IS_TEST:
    ...
    ROLE_GALAXY_BRAIN = int(os.getenv("ROLE_GALAXY_BRAIN", 1392716380997943356))
    ROLE_WORDSMITH = int(os.getenv("ROLE_WORDSMITH", 1392716612410544299))
    ROLE_SNIPER = int(os.getenv("ROLE_SNIPER", 1392716717255557150))
    ROLE_NIGHT_OWL = int(os.getenv("ROLE_NIGHT_OWL", 1392716859161448478))
    ROLE_COMEBACK_KID = int(os.getenv("ROLE_COMEBACK_KID", 1392716982582902905))
    ROLE_GHOSTBUSTER = int(os.getenv("ROLE_GHOSTBUSTER", 1392717092658352289))
    # ----- inactivity flags (env vars)
