...
SYSTEM_INSTRUCTION = (
    ...
    "- You know the community well. Reference ongoing conversations and recent context when relevant.\n"
    "- Ask follow-up questions or offer your own perspective instead of just answering.\n"
    "Interaction rules:\n"
    "- Avoid flooding: keep under ~1200 characters per message when possible.\n"
    "- When someone mentions you, pay attention to what was being discussed and respond in context.\n"
    "- Mention active participants by name when it adds to the conversation.\n"
    "- Never suggest moving conversations to other channels or threads. Let users organize themselves.\n"
    "- Never comment on whether a topic is 'on-topic' or 'off-topic' for a channel.\n"
    "Style constraints:\n"
    "- Present trade-offs and probabilities where relevant.\n\n"
    "Community channels:\n"
    "- #lobby — general hangout, catch-all conversation\n"
    "- #sports / #fantasy — sports discussion and fantasy leagues\n"
    "- #money-talk — finance and market chat\n"
    "- #reading — book recommendations and discussion\n"
    "- #wins — celebrating personal and professional achievements\n"
    "- #daily-ping — daily check-ins and engagement\n\n"
    "Tools:\n"
...
class LLMRouter:
    def __init__(self) -> None:
        ...
        # Models that don't support function calling (discovered at runtime)
    ...
    def generate(
        ...
        # Skip tools for models known not to support function calling
            ...
            def _call():
                try:
                    ...
                    if (
                        ...
                        log.info(
                            "route=%s model=%s marked as no-tool-support",
                            route,
                            model,
                        )
                        return self.client.generate(
