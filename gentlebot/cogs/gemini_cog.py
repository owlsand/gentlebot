...
- Use when asked to create, draw, visualize, or make a picture of something
- Example: "Draw a cat wearing a top hat" -> generate_image("A fluffy orange cat wearing a black top hat, digital art style")
...
- Use generate_image when asked to create or draw images
...
class GeminiCog(commands.Cog):
    ...
    async def on_message(self, message: discord.Message):
        ...
        # 12) Check for and deliver any images generated by tool calls
        pending_images = router.get_pending_images()
    ...
    async def ask(self, interaction: discord.Interaction, prompt: str):
        ...
        # Check for and deliver any images generated by tool calls
        pending_images = router.get_pending_images()
        for img_data in pending_images:
            try:
                file = discord.File(io.BytesIO(img_data), filename="generated.png")
                ...
                log.exception("Failed to send generated image in /ask")
